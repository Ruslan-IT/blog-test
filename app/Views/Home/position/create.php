            ...
            <div class="row">
                <div style="padding: 0 20px; " class="col-12">
                    ...
                    <div class="page-title-box card-body">
                        ...
                        <h4 class="page-title"><font dir="auto" style="vertical-align: inherit;"><font dir="auto" style="vertical-align: inherit;">Создать позицию</font></font></h4>
                            ...
                            <div class="table-responsive">
                                <form action="/position/store" method="POST">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="title" type="text" placeholder="Введите название позицию" id="example-text-input">
                                        </div>

                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 text-end">
                                            <button type="submit" class="btn btn-de-primary px-4"><font dir="auto" style="vertical-align: inherit;"><font dir="auto" style="vertical-align: inherit;">Добавить</font></font></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
