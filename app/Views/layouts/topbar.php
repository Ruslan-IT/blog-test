            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="assets/images/users/user-4.jpg" alt="профиль-пользователь" class="rounded-circle me-2 thumb-sm">
                        <div>
                            <small class="d-none d-md-block font-11"><font dir="auto" style="vertical-align: inherit;"><font dir="auto" style="vertical-align: inherit;">Администратор</font></font></small>
                            <span class="d-none d-md-block fw-semibold font-12"><font dir="auto" style="vertical-align: inherit;"><font dir="auto" style="vertical-align: inherit;">Мария Гибсон</font></font><i class="mdi mdi-chevron-down"></i></span>
                        </div>
                    </div>
                </a>
        ...
        <ul class="list-unstyled topbar-nav mb-0">
            ...
            <li class="hide-phone app-search">
                <form role="search" action="#" method="get">
                    <input type="search" name="search" class="form-control top-search mb-0" placeholder="Введите текст...">
